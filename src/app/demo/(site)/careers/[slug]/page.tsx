...
export async function generateMetadata({ params }: PageProps<"/demo/careers/[slug]">): Promise<Metadata> {
...
export default async function JobPage({ params }: PageProps<"/demo/careers/[slug]">) {
  ...
  return (
    <Container className="py-12 sm:py-16">
      ...
      <Link href="/demo/careers" className="inline-flex items-center gap-1.5 text-sm font-semibold text-brand-700 hover:underline">
      ...
      <div className="mt-6 grid gap-10 lg:grid-cols-[1fr_20rem]">
        ...
        <aside className="lg:sticky lg:top-28 lg:self-start">
          <div className="rounded-3xl bg-white p-6 ring-1 ring-ink-100">
            ...
            {open ? (
              <ButtonLink href={`/demo/careers/${job.slug}/apply`} size="lg" className="mt-6 w-full">
                Apply now
              </ButtonLink>
            ) : (
              <ButtonLink href="/demo/careers" size="lg" variant="secondary" className="mt-6 w-full">
