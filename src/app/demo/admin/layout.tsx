...
const nav = [
  { href: "/demo/admin", label: "Overview" },
  { href: "/demo/admin/applications", label: "Applications" },
  { href: "/demo/admin/jobs", label: "Job postings" },
];

export default async function AdminLayout({ children }: LayoutProps<"/demo/admin">) {
      ...
      <header className="border-b border-ink-100 bg-white">
        <Container className="flex flex-wrap items-center justify-between gap-4 py-3">
          ...
          <div className="flex items-center gap-5 text-sm">
            ...
            <Link href="/demo" className="font-semibold text-ink-700 hover:text-brand-700">
              View site
            </Link>
            <SignOutButton />
          </div>
