...
export default async function CareersPage({ searchParams }: PageProps<"/demo/careers">) {
    ...
    <>
      ...
      <Container className="py-12">
        ...
        <div className="mt-8 flex items-center justify-between">
          ...
          {filtered && (
            <Link href="/demo/careers" className="text-sm font-semibold text-brand-700 underline">
              Clear filters
            </Link>
          )}
        </div>
        ...
        {jobList.length === 0 && (
          <div className="rounded-3xl bg-white p-10 text-center ring-1 ring-ink-100">
            ...
            <ButtonLink href="/demo/signup" className="mt-6">
              Create an account
            </ButtonLink>
          </div>
        )}
